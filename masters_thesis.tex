...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\listadd{\titlelines}%
  {Augmenting Academic Research Search And Access With}             %<Enter the title of the dissertation
\listadd{\titlelines}%
  {Richer Context Representations}            % If you want to
...
\newcommand*{\degreename}
  {Master's Of Science In Computer Science}                %<Enter the type of degree (capitalized)
...
\newcommand{\bibfilename}{%             %<Enter the name of the *.bib file containing the
  src/thesis/library%                   %   reference information for sources cited in
...
\include{src/thesis/introduction}                     %<Insert your chapters here; I recommend to use
