...
\listadd{\titlelines}%
  {Rich Context Representations}            % If you want to
...
\newcommand*\defdate{April 2021}        %<Give month (written out fully) and year of
                                        %   the oral defense
\listadd{\committeechair}{Dr. Jia Zou}   %<Enter committee chair name; use \listadd for
\listadd{\committeechair}{Dr. Heni Ben Amor}%   for additional names
\newcommand*{\chairlabel}{Co-Chair}        %<If you have co-chairs, replace this text with
                                        %   'Co-Chair'
\listadd{\committeemember}{Dr. Kasim Selcuk Candan} %<Enter committee member names; use \listadd for
...
\input{src/thesis/abstract}             %<Enter the name of the .tex file containing your
...
\input{src/thesis/dedication}           %<Enter the name of the .tex file containing your
                                        %   your dedication or omit this line and type in
                                        %   your dedication here.

\chapter*{Acknowledgments}              %~Acknowledgments are optional
\input{src/thesis/acknowledgments}      %<Enter the name of the .tex file containing your
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mainmatter
% \include{src/thesis/chapter}                     %<Insert your chapters here; I recommend to use
\include{src/thesis/introduction} 
% \include{src/thesis/background}                     %<Insert your chapters here; I recommend to use
\include{src/thesis/relatedworks}
\include{src/thesis/method}
\include{src/thesis/sci-genie}
\include{src/thesis/table-classification}
\include{src/thesis/sci-genie-extension}
\include{src/thesis/conclusion}
