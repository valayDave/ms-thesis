...
\begin{figure}[p]
    ...
    \caption{Average training loss, accuracy and F1 score during the training process for the classification task across 8 runs using caption only Transformer with/without pretraining, and the E-MCT with/without pretraining. }
    \label{figure\arabic{figurecounter}}
\end{figure}
\refstepcounter{figurecounter}
...
\begin{figure}[p]
    ...
    \caption{Average training loss, accuracy and F1 Score during the training process for the classification task across 8 runs using CCT with/without pretraining and Finetuning Sci-Bert.}
    \label{figure\arabic{figurecounter}}
\end{figure}
\refstepcounter{figurecounter}
